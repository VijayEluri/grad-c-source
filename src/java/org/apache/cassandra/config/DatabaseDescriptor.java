    ...
    */
    ...
    static
    {
        try
        {
            ...
            /*[MODIFIED] I give the priority to the Run-Time variable*/
            String port = System.getProperty("Storage_StoragePort");
            if(port != null){
            	storagePort = Integer.parseInt(port);
            }else{
            	port = xmlUtils.getNodeValue("/Storage/StoragePort");
                if ( port != null )
                    storagePort = Integer.parseInt(port);
            }
            ...
            /*[MODIFIED] I give the priority to the Run-Time variable*/
            String listenAddr = System.getProperty("Storage_ListenAddress");
            if(listenAddr == null){
            	listenAddr = xmlUtils.getNodeValue("/Storage/ListenAddress");
            }
            if (listenAddr != null)
            {
            ...
            /*[MODIFIED] I give the priority to the Run-Time variable*/
            String thriftAddr = System.getProperty("Storage_ThriftAddress");
            if(thriftAddr == null){
            	thriftAddr = xmlUtils.getNodeValue("/Storage/ThriftAddress");
            }
            ...
            /*[MODIFIED] I give the priority to the Run-Time variable*/
            port = System.getProperty("Storage_ThriftPort");
            if(port == null){
            ...
            /*[MODIFIED] I give the priority to the Run-Time variable*/
            /*TODO:we improved to permit multiple DataFileDirectories*/
            String dir = System.getProperty("Storage_DataFileDirectories_DataFileDirectory");
            if(dir != null){
            	dataFileDirectories = new String[1];
            	dataFileDirectories[0] = dir;
            }else{
                dataFileDirectories = xmlUtils.getNodeValues("/Storage/DataFileDirectories/DataFileDirectory");
            }
            dir = System.getProperty("Storage_CommitLogDirectory");
            if(dir != null){
            ...
            dir = System.getProperty("Storage_SavedCachesDirectory");
            if(dir != null){
            	savedCachesDirectory = dir;
            }else{
            ...
            /*[MODIFIED] I give the priority to the Run-Time variable*/
            /*TODO:we improved to permit multiple seeds*/
            int seeds_length = Integer.valueOf(System.getProperty("Storage_Seeds_Length"));
	    String[] seedsxml;
            if(seeds_length <= 0){
            	seedsxml = xmlUtils.getNodeValues("/Storage/Seeds/Seed");
            }else{
		int i=0;
            	seedsxml = new String[seeds_length];
            	while(true){
            		String seed_temp_i = System.getProperty("Storage_Seeds_Seed"+ i);
            		if(seed_temp_i == null){
            			break;
            		}else{
            			seedsxml[i] = seed_temp_i;
            			i+=1;
            		}
            	}
            }
